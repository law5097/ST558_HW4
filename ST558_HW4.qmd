...
# set url for API
url <- 'https://newsapi.org/v2/everything?q=tesla&from=2024-05-23&sortBy=publishedAt&apiKey=f07771c038d24e65aeaf85752af8bb4a'

# get the data form the API
url_data <- httr::GET(url) |>
  # parse the content as text
  content(as = 'text') |>
  # convert json to R df
  fromJSON(flatten = TRUE, simplifyDataFrame = TRUE) 
  # pull specified section
  pluck('articles')
